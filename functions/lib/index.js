...
exports.validateSchemaL5 = exports.validateSchemaL4 = exports.validateSchemaL3 = exports.validateSchemaL2 = exports.validateSchemaL1 = void 0;
...
exports.validateSchemaL1 = functions.firestore
    .document("{c1}/{d1}")
    .onCreate((snap) => handleCreate(snap));
exports.validateSchemaL2 = functions.firestore
    .document("{c1}/{d1}/{c2}/{d2}")
    .onCreate((snap) => handleCreate(snap));
exports.validateSchemaL3 = functions.firestore
    .document("{c1}/{d1}/{c2}/{d2}/{c3}/{d3}")
    .onCreate((snap) => handleCreate(snap));
exports.validateSchemaL4 = functions.firestore
    .document("{c1}/{d1}/{c2}/{d2}/{c3}/{d3}/{c4}/{d4}")
    .onCreate((snap) => handleCreate(snap));
exports.validateSchemaL5 = functions.firestore
